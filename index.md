...
主機發售當月出版的《A'can 特輯》（尖端出版，1995 年 10 月）是目前最接近開發現場的材料，
內容由開發公司提供。它講得出數字的四項規格，與 2026 年在暫存器層級量到的結果全部對得上。

<div class="docs" markdown="1">

- [1995 年的說法與 2026 年的量測](docs/console-history.md)
  <span class="note">逐項對照、三件補到的事（F-16 的一手出處、開發期、F007 的開發商），以及一處需要並陳的說法。</span>
- [一手史料：《A'can 特輯》](docs/history/README.md)
  <span class="note">敦煌科技、聯華電子、精訊資訊與全崴資訊的史文，以及 1995 年編年史。</span>
